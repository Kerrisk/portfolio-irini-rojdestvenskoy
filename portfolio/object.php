<?php
/**
* Template Name: Предметная съемка
* Template Post Type: page
*/
?>
<title>Предметная съемка</title>
<?get_header();?>
<body>
        ...
        <nav class="header__nav">
            ...
            <ul class="header__list"> 
                <li class="header__item2"><a class="navodka_vis2" href="https://eclarina.ru/predmetnaya-semka/">Предметная съемка</a></li>
                <li class="header__item2"><a class="navodka2" href="https://eclarina.ru/priklyucheniya/">Приключения</a></li>
                <li class="header__item2"><a class="navodka2" href="https://eclarina.ru/portret/">Портрет</a></li>
    ...
    <section class="wrapper">
            <article class="designation">Предметная съемка</article>
        </section>
    <main class="hero2 wrapper">
    <?php if( have_rows('hero_item-igm3') ): ?>
            <?php while ( have_rows('hero_item-igm3') ) : the_row('') ?>
        <div>
            <img class="hero__item-img" src="<?=the_sub_field('photo-3');?>"alt="<?=the_sub_field('label-3');?>"> 
            </div>
            <?php endwhile; ?>
    <?php endif; ?> 
    </main>
