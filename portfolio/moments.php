<?php
/**
* Template Name: Яркие моменты
* Template Post Type: page
*/
?>
<title>Яркие моменты</title>
<?get_header();?>
<body>
        ...
        <nav class="header__nav">
            ...
            <ul class="header__list"> 
                ...
                <li class="header__item2"><a class="navodka_vis2" href="https://eclarina.ru/yarkie-momenty/">Яркие моменты</a></li>
            </ul>
        </nav>
    ...
    <section class="wrapper">
            <article class="designation">Яркие моменты</article>
        </section>
    <main class="hero2 wrapper">
    <?php if( have_rows('hero_item-igm5') ): ?>
            <?php while ( have_rows('hero_item-igm5') ) : the_row('') ?>
        <div>
            <img class="hero__item-img" src="<?=the_sub_field('photo-5');?>"alt="<?=the_sub_field('label-5');?>"> 
            </div>
            <?php endwhile; ?>
    <?php endif; ?> 
    </main>
