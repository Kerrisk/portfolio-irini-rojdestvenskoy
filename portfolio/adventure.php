...
<body>
        ...
        <nav class="header__nav">
            ...
            <ul class="header__list"> 
                ...
                <li class="header__item2"><a class="navodka_vis2" href="https://eclarina.ru/priklyucheniya/">Приключения</a></li>
    ...
    <section class="wrapper">
            <article class="designation">Приключения</article>
        </section>
    <main class="hero2 wrapper">
    <?php if( have_rows('hero_item-igm2') ): ?>
            <?php while ( have_rows('hero_item-igm2') ) : the_row('') ?>
        <div>
            <img class="hero__item-img" src="<?=the_sub_field('photo-2');?>"alt="<?=the_sub_field('label-2');?>"> 
            </div>
            <?php endwhile; ?>
    <?php endif; ?> 
    </main>
